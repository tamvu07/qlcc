 ...
 <body id="tc">
 	<div class="main">
    	...
    	<div style="width: 10px;height: 20px;float: right;margin-top: 20px;z-index: auto;">
	 	  ...
	 	  <ul id="ul" style="margin-left: 280px;margin-top: 170px;">
	          <li><a href="masterpage.php?p=danhsachnhansu" ><button type="submit" name="btn-ql" value="ql-ns" id="btn-ql" >Quản lí nhân sự</button></a></li>
	          <li><a href="masterpage.php?p=hopdongnhanvien"><button type="submit" name="ql-kh">Hợp đồng nhân sự</button></a></li>
	     </ul> 
 	</div>
 </body>
 </html>
