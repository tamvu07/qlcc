 ...
 <body id="tc">
 	<div class="main"> 
       ...
       <div style="width: 10px;height: 20px;float: right;margin-top: 20px;z-index: auto;">
       	...
       	<h3 align="center" style=" font-family: monospace;color: black;font-size: 34px;margin-top: 34px">Thông tin nhân sự</h3>
			...
			<th style="text-align: center;">Mã số</th>
	 		...
	 		<tr align="center" >
	 			<td colspan="7" style="margin-top: 20px">
	 				<a href="masterpage.php?p=themnhansu"><button id="them-ns-btn2">Thêm nhân sự</button></a>
	 			</td>		
	 		</tr>
	 	</table>
