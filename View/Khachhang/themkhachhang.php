 	...
 	<div class="main"> 
      <div class="top-qlns">	
       ...
       <div style="width: 10px;height: 20px;float: right;margin-top: 20px;z-index: auto;">
       	<a href="masterpage.php?p=thongtinkhachhang"><i class="fas fa-chevron-circle-left fa-3x" style="float: right;margin-right: 30px;color:blue"></i></a>
       </div>
       		<div id="them-ns" align="center" >
       			<!-- <h3 align="center">Điền thông tìn vào form</h3> -->
				<form action="" method="post">
					<h3 style="padding-bottom: 15px;font-family: monospace; color: white; background-color: #222222	;padding-top: 10px;">Nhập thông tin khách hàng</h3>
		 			<table id="them-ns-table">
		 				<tr >
		 					<td>
		 						<p style="font-size: 20px;color: black">Tên khách hàng :</p>
		 					</td>
		 					<td>
		 				...
		 				<tr>
			 				<td>
			 					<p style="font-size: 20.5px;color: black">Mã khách hàng :</p>
			 				</td>
			 				<td>
		 				...
		 				<tr>
			 				<td>
			 					<p style="font-size: 21px;color: black">Năm Sinh :</p>
			 				</td>
			 				<td>
		 				...
		 				<tr>
			 				<td>
			 					<p style="font-size: 20px;color: black">Ngày vào :</p>
			 				</td>
			 				<td>
		 				...
		 				<tr>
			 				<td align="center">
			 					<input type="submit" name="" value="Thêm khách hàng" id="submit-ns" style="color: black">
